<template lang="html">
  <div class="pay_body">
    ...
    <div class="jisuan_div">
      ...
      <mt-cell v-show="ksydjjList.length > 0" title="代金券" is-link @click.native="popupClick">
    ...
    <div class="sure_pay">
      ...
      <div class="text-center">
        <mt-button style="margin-top: 10px;" type="danger" @click='clearCookie'>清除cookies(用于测试)</mt-button>
        <mt-button style="margin-top: 10px;" type="danger" @click='toLink'>新支付页面(用于测试)</mt-button>
      </div>
    </div>

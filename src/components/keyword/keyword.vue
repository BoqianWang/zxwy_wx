<template>
    <div class='key-container'>
        ...
        <div class='keyboard' @touchstart='_handleKeyPress'>
            <div class='key-row'>
                <div class='key-cell' data-num='7'>7</div>
                <div class='key-cell' data-num='8'>8</div>
                <div class='key-cell' data-num='9'>9</div>
                <div class='key-cell' data-num='D'><i class="iconfont icon-keyboard-delete del" style="font-size:30px;" data-num='D'></i></div>
            </div>
            <div class='key-row'>
                <div class='key-cell' data-num='4'>4</div>
                <div class='key-cell' data-num='5'>5</div>
                <div class='key-cell' data-num='6'>6</div>
                <div class='key-cell' data-num='C'></div>
            </div>
            <div class='key-row'>
            ...
            <div class='key-confirm' data-num='S' v-show="isClick==true">
              <p data-num='S'>确认</p>
              <p data-num='S'>支付</p>
            </div>
            <div class='key-confirm no-confirm' data-num='-1' v-show="isClick==false">
              <p data-num='S'>确认</p>
              <p data-num='S'>支付</p>
            </div>
        </div>
